...
- TypeScript 5.x / Node.js 20+ + `@whiskeysockets/baileys`, `pi-agent-sdk`, `pino`, `qrcode-terminal` (024-short-name-fix)
- Local file-based recents/session state under `.pi-data/` and `~/.pi/whatsapp-pi/` (024-short-name-fix)
...
## Recent Changes
- 024-short-name-fix: Added TypeScript 5.x / Node.js 20+ + `@whiskeysockets/baileys`, `pi-agent-sdk`, `pino`, `qrcode-terminal`
